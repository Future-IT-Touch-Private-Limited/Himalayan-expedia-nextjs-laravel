...
export default function CheckList({ data }) {
  ...
  return (
    <div id="document-checklist" className="checkList">
      <div className="px-5 py-5 md:px-15  mt-5 md:py-2">
        ...
        <div className="CheckList-documents mt-5 md:my-10 border">
          ...
          <div className="border   ">
            ...
            {/* {data?.Employed[0]?.heading && (
              <div className="EmploymentSection">
                <div
                  className="Age px-5 py-3 border cursor-pointer bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow"
                  onClick={() => toggleSection("employed")}
                >
                  <h3 className="text-xl flex items-center justify-between">
                  <span className="bg-sky-200 p-2 rounded-md">Day 1</span>    Employed
                    <MdKeyboardArrowDown
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-3">
                      {data.Employed.map((item) => (
                        <div
                          ...
                          className="cursor-pointer flex items-center gap-3 p-3  rounded-lg bg-white shadow-md hover:shadow-lg transition-transform"
                        >
...
{/* 
            {data?.isFunded[0]?.heading && (
              <div className="EmploymentSection">
                ...
                >
                  <h3 className="text-xl flex items-center justify-between">
                  <span className="bg-sky-200 p-2 rounded-md">Day 1</span>   Funded
                    <MdKeyboardArrowDown
                      className={`text-xl transition-transform ${
            ...
            {/* {data?.Self_employed[0]?.heading && (
              <div className="EmploymentSection">
                ...
                >
                  <h3 className="text-xl flex items-center justify-between">
                  <span className="bg-sky-200 p-2 rounded-md">Day 1</span>    Self Employed
                    <MdKeyboardArrowDown
                      className={`text-xl transition-transform ${
            ...
            {/* {data?.Student[0]?.heading && (
              <div className="EmploymentSection">
                ...
                >
                  <h3 className="text-xl flex items-center justify-between">
                  <span className="bg-sky-200 p-2 rounded-md">Day 1</span>      Student
                    <MdKeyboardArrowDown
                      className={`text-xl transition-transform ${
